...
class CVEFixesDatasetNLPLine:
    """Override getitem for codebert."""

    def __init__(self, partition="train"):
        """Init."""
        linedict = prep.get_dep_add_lines_CVEFixes()
        df = prep.CVEFixes()
...
class CVEFixesDatasetNLPDataModule(pl.LightningDataModule):
